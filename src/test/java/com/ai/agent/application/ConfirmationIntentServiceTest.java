...
import static com.ai.agent.application.ConfirmationIntentService.ConfirmationIntent.AMBIGUOUS;
import static com.ai.agent.application.ConfirmationIntentService.ConfirmationIntent.CONFIRM;
import static com.ai.agent.application.ConfirmationIntentService.ConfirmationIntent.REJECT;
...
class ConfirmationIntentServiceTest {
    ...
    void noProblemCancelItIsConfirmationInsteadOfRejection() {
        ...
        assertThat(service.classify("没问题，按刚才的取消方案继续处理")).isEqualTo(CONFIRM);
    }
